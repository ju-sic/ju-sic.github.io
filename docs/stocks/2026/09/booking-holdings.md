...
| **최종 투자의견** | **분할 매수 (Buy on Dip)** / 52주 저점($150.14) 지지대 접근 및 과매도(RSI 21.5) 구간 선발대 진입 (투자 가치 점수 **82.0점**, 6.1절) |
...
| **종합 가중치 환산 점수** | **100%** | — | **82.0점** | **`Buy`** | **펀더멘털과 밸류에이션은 극상, 지지대 접근 구간에서 선발대만 분할 진입** |
...
#### ① 지금 당장 사야 하는가? ➔ **"선발대만 발을 담가라. 본대는 바닥 양봉을 확인하고 실어라."**

- **선발대(30%)를 지금 넣어도 되는 이유**: 주가가 올해 두 번 지켜낸 $150 지지대의 3.8% 위까지 내려왔고, RSI(14)가 21.5로 과매도 구간이다. Forward PER 12.6배는 모건스탠리가 보는 적정 배수(약 18배)보다 30% 싸다. 손절선 $145까지의 거리가 -7.0%로 짧아 위험을 계산할 수 있는 자리다.
- **주력(본대)을 바로 몰빵하지 않는 이유**: 9월 22~23일 이틀 연속 평균의 2배가 넘는 거래량(합계 2,823만 주)을 동반한 하락이 나왔다. 매도 압력이 아직 소진되지 않았다는 뜻이다. 투매의 관성이 이어지며 $150 선을 일시적으로 깨는 언더슈팅(Undershooting)이 나올 수 있다. 떨어지는 칼날을 맨몸으로 받아내지 말고, $150선 지지 양봉이 출현할 때 주력을 실어야 한다.
...
| :--- | :--- | :---: | :---: | :--- |
| **1차 진입 (선발대)** | 현 가격대, $150 지지대 접근 및 RSI 21.5 과매도 | **30%** | **$150 ~ $156** | 공포 투매 국면에서 헐값에 기본 정찰대 물량 확보 |
| **2차 매수 (주력)** | $150 지지 확인 후 일봉상 거래량 감소 및 반등 양봉 출현 | **35%** | **$158 ~ $165** | 2·5월에 이은 세 번째 $150 지지 확인 및 단기 하락 추세 탈출 시 핵심 물량 투입 |
...
만약 1차 매수 후 $150을 일시적으로 하회하는 패닉 오버슈팅이 발생하더라도, $145가 종가 기준으로 깨지지 않는 한 손절하지 않고 2차 매수 타이밍을 노린다.
...
!!! tip "최종 핵심 제언 (Executive Takeaway)"
    - **최종 투자 가치 점수**: **82.0점 / 100점** (`Buy` / $150 지지대 접근 및 과매도, 가치회귀 스윙 타점)
    ...
    - **행동 원칙**: 공포에 질려 패닉셀하는 대중의 물량을 비웃어라. 선발대 30%는 지금 담고, 본대 35%는 $150 지지 양봉에 싣고, 손절은 $145 종가 이탈에 걸어둬라. 냉혹하게 숫자를 믿고 손익비가 극대화된 자리에서만 방아쇠를 당겨라.
